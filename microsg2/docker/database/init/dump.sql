...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 04 jan. 2021 à 11:58
...
--
-- Base de données :  `microsg2`
--
DROP DATABASE IF EXISTS `microsg2`;
CREATE DATABASE IF NOT EXISTS `microsg2` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `microsg2`;
...
(51, 1, 0, 'dclkz,c,zlkc,lzmkec,mzle,cmzl,ecz', '2021-01-04', 'kdvnsldns');
...
(1, 'Järna', '$2a$10$lLpWntpelgtzL8m8LlgG/.fMrumohKtGm3dyUXoibBGZZmik1eDv2', 'vreihill0'),
(2, 'Sherwood Park', '$2a$10$3YpXT8taSDnHo8Wtg0ZAJOM860SamIgH6FPW73aVXGDxctrZES4je', 'fcocks1'),
(3, 'Tolú', '$2a$10$WquAjDFMF4d.Ela8EXVryuW2qyrgb241M0FXNEtzNnavXNq8ChdgK', 'mrehme2'),
(4, 'Lembursawah', '$2a$10$uP9JahWRyQbkeAO6AaKcXeUU8Tnyhj5Z9a0m0QIp9gruAQNt8VJxK', 'amouth3'),
(5, 'Åhus', '$2a$10$JYj8HgaDE1TWeHgwXvSzj.oiLjnzAjidYUnJT/UFvTYgkgAVZdC.u', 'mdutteridge4'),
(6, 'Korostyshiv', '$2a$10$tB7Nuzfb4s5rUKWnETB8M.QS6JK7HJD5u6ZwGEVdRcit4YCLh.jp.', 'pollet5'),
(7, 'Jindong', '$2a$10$yMURPtYkPlCMjVmllHoWEepf8TJIjqZp/UqaFlCTK9ZWp5DYTevkW', 'gfeldmus6'),
(8, 'Astorga', '$2a$10$hVWuxm28IE63v9MnhdpoQuvjSUXNSjdqHCu/mw2ohHD8VDgKRiOUi', 'djones7'),
(9, 'Katyr-Yurt', '$2a$10$3OBzR7Kwqd3lIFI5U4cCru3ZOHHXri4g13zDVKReycDVJFGvDI1iG', 'ngrevel8'),
(10, 'Monte', '$2a$10$3SLJk7vyQHunzxuP7TZNN.NrEsEfrOYLIi9Ht5AIupfJkJK0fOA.q', 'acorbishley9'),
(11, 'Kamionka', '$2a$10$7SSALERiwrlSQ3hnFTdBTuYewAZvZt3GZVwYOjPZEcXHxCIEgyoiO', 'orodenborcha'),
(12, 'Woken', '$2a$10$dFc2nf.0dN.O5c.U.jRotekcvN3RSpSpi3abnblTC3HfLkJI02bgK', 'fhandoverb'),
(13, 'Santiago', '$2a$10$8ZnPD1EH9IAlqf5LbTtAqOKhRbemT21uV8q/h8Gi2ND4C7g.gbJP.', 'bluetkemeyersc'),
(14, 'Shisui', '$2a$10$ZxrEKCFERUn45M9Lyqink.rJUEfzB1Xk6bRP9TCNz1uQ.bvs7clg2', 'sbodend'),
(15, 'Dinghuo', '$2a$10$3UBqkcYPTF4g4UVryDZWU.HRdUtdFxzbdQSNVga3Vr9YuRrEgSks2', 'hjohanssone'),
(16, 'Jianghua', '$2a$10$EC9kFzkZCRpgFNgqsg7I9uj7yf60HUXo3eTDJby8T8UjwGk0I0TZi', 'fharcarsef'),
(17, 'Undurkhaan', '$2a$10$FH5s8snz1mr/tRikjI61sOw/XGlSWHdRZO7CU1I/YDkQc3Ui8./a.', 'oreckhouseg'),
(18, 'Komprachcice', '$2a$10$6BfwsrGHtf4uvehULqJUwuY8W4lBoydyvmmiiLh5cDcyF13DRheFS', 'npeppinh'),
(19, 'Munduk', '$2a$10$exl/40x1635XqLg1kURV2O8Z9auoTuYksjYK6flhaMfEu6Hf/VxxK', 'zjohanssoni'),
(20, 'Laâyoune / El Aaiún', '$2a$10$hOG8wgtPale5OWxh5gzUK.O5qN0s3TT0ee/pe6khhKSi8YFA7JKx2', 'kilchukj'),
(21, 'Áno Sýros', '$2a$10$asoXFkgr8HZGM33gnT/JIOdRh/jiIiaNCs6Ami7S7bEPWU153.b9K', 'tgailork'),
(22, 'Yanglin', '$2a$10$IPrvWacaRN/tY94juStHtOVRsvgT5IU5zJKRK3P2AmS4LKhlyMJfy', 'cshilloml'),
(23, 'Paris 07', '$2a$10$AF18AIarQdg9SOGwKneTSe4/xO4SErTdGov8vsN0GpUio9dBFIjR6', 'imanniem'),
(24, 'Botucatu', '$2a$10$9xY1LIY1iPH5J9delWmcseyL4ZNfQkB.NnYBl1zvngvx5Ks9aFjLy', 'smcgraylen'),
(25, 'El Plan', '$2a$10$sK3toZjtkIDMp2RAVif1lOwwRIy/LLB.EMGhO0rFQ18MXaDN5ABli', 'cstraseo'),
(26, 'paul.test@gmail.Com', '9cf95dacd226dcf43da376cdb6cbba7035218921', 'paulo'),
(27, 'paulito@gmail.com', '$2a$10$JybKA/aPLn3PnlzRIOvLr.qa9SIBDcE9FvLEOdVCOepou3JUTVWsO', 'paulito'),
(28, 'paulo@gmail.com', '$2a$10$enLPqErjgvVnDF9jINPZC.VVV4CvCbQLkIZV3HmByMORbk3.sys.6', 'paulopaulo'),
(29, 'pol@pol.pol', '$2a$10$V6AvNITKlEO17O058uKvounrMrjntIAxlO9J1VNKqpDa5sxlwe6ny', 'pol');
...
(28, 33, 18, 'Morbi quis tortor id nulla ultrices aliquet.', '2020-06-08'),
...
(251, 3, 1, ',so,cozeizefz', NULL),
(252, 3, 1, 'zefzefzefzefz', NULL),
(253, 2, 1, 'kjcneonfeofn', NULL),
(254, 1, 1, 'rofieogfeinrgoe', NULL),
(255, 1, 1, 'jfvldfnvdlf', NULL),
(256, 4, 1, 'kjvsndvnskd', NULL),
(257, 51, 29, 'zkecnzlcnzlekc', '2021-01-04'),
(258, 51, 29, 'ldkf,zpdkf,', '2021-01-04'),
(259, 51, 29, 'zlkc,zlke,', '2021-01-04');
COMMIT;
